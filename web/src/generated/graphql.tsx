...
export type PostSnippetFragment = { __typename?: 'Post', id: number, createdAt: string, updatedAt: string, title: string, textSnippet: string, points: number, creatorId: number, creator: { __typename?: 'User', id: number, username: string, createdAt: string } };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<{ __typename?: 'Post', id: number, createdAt: string, updatedAt: string, title: string, textSnippet: string, points: number, creatorId: number, creator: { __typename?: 'User', id: number, username: string, createdAt: string } }> } };
